...
bool compareNodes(TreeNode* r1, TreeNode* r2) {
...
bool flipEquiv(TreeNode* root1, TreeNode* root2) {
    ...
    if (compareNodes(root1->left, root2->left)) {
        return compareNodes(root1->right, root2->right) &&\
            flipEquiv(root1->left, root2->left) &&\
            flipEquiv(root1->right, root2->right);
    }

    if (compareNodes(root1->left, root2->right)) {
        return compareNodes(root1->right, root2->left) &&\
